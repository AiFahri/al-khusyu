...
export function Education() {
  const schools = [
    {
      title: "SMK ALKHUSYU",
      desc: "SMK Al-Khusyu' mengintegrasikan pendidikan umum, keterampilan vokasi, dan pembentukan karakter islami. Terletak di ujung selatan Kabupaten Blitar yang berbatasan langsung dengan Kabupaten Malang, sekolah ini menjadi tempat belajar bagi siswa dari berbagai daerah, termasuk dari luar pulau seperti Kalimantan. ",
      location: "Blitar",
    ...
    {
      title: "SMP ALKHUSYU",
      desc: "SMP Pesantren Al-Khusyu' bertujuan untuk menghasilkan lulusan yang berbudi pekerti Islam, generasi qur’ani, dan berjiwa enterprenuership; serta mewujudkan tatakelola pendidikan yang berorientasi pada kelestarian lingkungan dan kesejahteraan para stakeholders.",
      location: "Blitar",
    ...
    {
      title: "MI AL KHUSYU",
      desc: "MI Al-Khusyu' menekankan pembelajaran berdiferensiasi, projek profil pelajar Pancasila, serta penguatan kompetensi holistik.",
      location: "Blitar",
    ...
    {
      title: "RA AL Khusyu",
      desc: "RA Al-khusyu memfasilitasi peserta didik pada satuan pendidikan anak usia dini berbasis islam yang menitik beratkan pada aspek perkembangan anak; transformasi dan internalisasi nilai-nilai spiritual keislaman.RA Al-Khusyu’ memiliki 5 orang guru dan 49 siswa pada Tahun Ajaran 2024-2025.",
      location: "Blitar",
      image: "/image/ra-1.webp",
      slug: "tk",
    },
    {
      title: "Baitul Qur'an Alkhusyu",
      desc: "Pondok Tahfidz Baitul Qur'an Al-Khusyu' adalah pesantren yang membekali peserta didik dengan akhlak mulia, nilai-nilai Islam, dan pengetahuan umum, serta siap menghadapi tantangan masa depan dengan kepribadian yang kuat.",
      location: "Blitar",
      image: "/image/smk.png",
      slug: "tahfidz",
    },
    ...
    <div className="flex flex-col justify-start gap-6 md:gap-8 px-4 md:px-8">
      <div className="flex flex-col lg:flex-row justify-start gap-6 lg:gap-12 xl:gap-30">
        <div className="flex flex-col gap-6 md:gap-8">
          <div className="bg-[#567471] text-white font-manrope rounded-[32px] px-4 md:px-6 lg:px-8 py-4 md:py-6 w-full max-w-[788px] h-auto md:h-[232px]">
            <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center h-full gap-4 md:gap-8">
              <div className="leading-[0.95] text-center md:text-left">
                <span className="block font-semibold text-3xl md:text-5xl lg:text-6xl xl:text-[80px]">
                  Santri
                </span>
                <span className="block font-semibold text-3xl md:text-5xl lg:text-6xl xl:text-[80px]">
                  Aktif
              ...
              <div className="text-center">
                <div className="font-semibold text-4xl md:text-6xl lg:text-7xl xl:text-[96px] leading-[0.9]">
                  390+
                </div>
                <div className="text-lg md:text-xl lg:text-2xl xl:text-[28px] mt-1">
                  Anak
                </div>
              </div>
            </div>
          ...
          <img
            src="/image/education-landing-page.png"
        ...
        <div className="flex flex-col gap-8 lg:gap-16 xl:gap-32 mt-6 lg:mt-0">
          <div className="inline-grid grid-cols-[auto_auto] grid-rows-[auto_auto] gap-x-2 items-center text-[#63817E] ulm-font font-extrabold leading-[0.9] justify-center lg:justify-start">
            <span className="col-start-1 row-start-1 text-2xl md:text-4xl lg:text-5xl xl:text-[76px]">
              Statistik{" "}
            </span>
            <span className="col-start-2 row-start-1 text-2xl md:text-4xl lg:text-5xl xl:text-[76px]">
              &
            </span>

            <div className="col-start-2 row-start-2 w-16 h-7 md:w-24 md:h-10 lg:w-32 lg:h-14 xl:w-[165px] xl:h-[71px] rounded-full overflow-hidden self-center -mt-1 xl:-mt-2">
              {" "}
              <img
            ...
            <span className="col-start-1 row-start-2 text-2xl md:text-4xl lg:text-5xl xl:text-[76px]">
              Capaian
            </span>
          </div>
          ...
          <div className="font-manrope text-[#757575] text-base md:text-lg lg:text-xl xl:text-[32px] font-semibold w-full max-w-[600px] leading-relaxed">
            Yayasan AL-KHUSYU terus berkembang dalam membina generasi Qurani.
            Kami telah mencetak ratusan santri aktif.
          </div>
        </div>
      </div>
              ...
              <Card className="rounded-3xl overflow-hidden border-0 bg-white">
                <CardContent className="p-4 md:p-6 flex flex-col gap-3 md:gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-3">
                    ...
                    <Button className="rounded-full bg-[#567471] hover:bg-[#4a6260] px-3 md:px-4 py-1 text-xs md:text-sm text-white hover:scale-105">
                      <Link
                        to={`/pendidikan/${s.slug}`}
