...
export default function BQ() {
  ...
  return (
    <div className="flex flex-col gap-16 px-8 my-8">
      <Headline
        name={"Baitul qur’an KIDS Al-khusyu’"}
        summary={
          "BQ Kids Al-Khusyu’ hadir sebagai lembaga pendidikan dasar yang membekali peserta didik\n" +
      ...
      <Mission
        name={"BQ AL-KHUSYU’"}
        vision={
          "Menjadi lembaga pendidikan Islam yang unggul dalam menanamkan akhlak dan kecintaan kepada Al-Qur’an sejak usia dini."
        }
        mission={
          "Mewujudkan pendidikan anak yang menyenangkan, religius, dan berkarakter melalui metode bermain sambil belajar sesuai ajaran Islam."
        }
      />
      {/* <Activity/>
            <Organization/>
