...
export default function TPQ() {
    ...
    return (
        <div className="flex flex-col gap-16 px-8 my-8">
            <Headline
                name={"TAMAN PENDIDIKAN QUR'AN AL-KHUSYU’"}
                summary={"TPQ Al-Khusyu’ hadir sebagai lembaga pendidikan dasar yang membekali peserta didik\n" +
