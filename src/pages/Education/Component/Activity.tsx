...
export function Activity({ title, description, activities }: ActivityProps) {
  return (
          ...
          {activities.map((item, idx) => (
            ...
            >
              <div className="flex flex-col gap-4 md:gap-6 lg:gap-8 h-full">
                <div className="w-full text-center mx-auto min-h-[200px] md:min-h-[220px] lg:min-h-[260px] flex flex-col justify-start">
                ...
                <img
                  src={item.image}
                  alt="logo"
                  className="w-full h-48 md:h-56 lg:h-[230px] object-cover rounded-2xl"
                />
              </div>
            </CarouselItem>
          ))}
