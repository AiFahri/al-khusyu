    ...
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
      <div className="flex flex-col gap-4 w-full lg:max-w-1/2 order-2 lg:order-1">
        <img
          src="/image/e-m-1.png"
          alt="logo"
          className="w-full h-auto max-h-48 md:max-h-64 lg:max-h-1/3 object-cover rounded-2xl"
        />
        <img
          src={imageUrl}
          alt="logo"
          className="w-full h-auto max-h-64 md:max-h-80 lg:max-h-2/3 object-cover rounded-2xl"
        />
      </div>
      ...
      <div className="flex flex-col gap-8 lg:gap-16 w-full lg:w-1/2 order-1 lg:order-2">
        <div className="inline-flex flex-col text-[#63817E] ulm-font font-extrabold leading-[0.9] mx-auto">
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-3">
            <span className="text-xl md:text-2xl lg:text-4xl xl:text-[76px] text-center md:text-left">
              TUJUAN
            </span>
        ...
        <div className="bg-white rounded-2xl px-4 md:px-6 lg:px-8 py-3 md:py-4 w-full lg:w-3/4 mx-auto">
          <p className="font-manrope font-semibold text-lg md:text-xl lg:text-2xl xl:text-[28px] text-[#63817E]">
            Visi
          </p>
        ...
        <div className="bg-white rounded-2xl px-4 md:px-6 lg:px-8 py-3 md:py-4 w-full lg:w-3/4 mx-auto">
          ...
          <div className="font-manrope font-semibold text-sm md:text-base lg:text-lg xl:text-[10px] text-[#757575] leading-relaxed">
            {mission.split("\n").map((line, index) => (
