...
export default function LKSA() {
    ...
    return (
        <div className="flex flex-col gap-16 px-8 my-8">
            <Headline
                name={"Lembaga Kesejahteraan Sosial Anak"}
                summary={"LKSA Al-Khusyu’ hadir sebagai lembaga kesejahteraan yang membekali peserta didik\n" +
