...
export default function Sanggar() {
    const imageList = [
    ...
    return (
        <div className="flex flex-col gap-16 px-8 my-8">
            <Headline
                name={"Sanggar Al-qur’an Al-Khusyu’"}
                summary={"Sanggar Al-Qur'an Al-KHUSYU’ hadir sebagai lembaga pendidikan dasar yang membekali peserta didik\n" +
