  ...
  const achievementList = [
    {
      ...
      summary:
        "Siswa Al-Khusyu' mendapatkan Juara 1 Lomba Marathon Putri dalam rangka HUT RI Ke 79 yang di laksanakan di Kecamatan Wates Kabupaten Blitar, membanggakan lembaga pendidikan dengan prestasi olahraga.",
    },
    {
      image: "/image/green.webp",
      title: "Go Green School Achievement",
      summary:
        "Wujudkan Go Green School, SMK Al-Khusyu' kembangkan bank sampah dan pertanian organik sebagai bagian dari program pendidikan lingkungan yang berkelanjutan dan memberikan dampak positif.",
    },
    {
      image: "/image/fotbar smk.webp",
      title: "Prestasi Digital Entrepreneur",
      summary:
        "Siswa SMK Al-Khusyu' berhasil mengembangkan aplikasi digital dan startup kreatif yang mengintegrasikan nilai-nilai Islam dengan teknologi modern di era industri 4.0.",
    },
  ];
    ...
    <>
      <div className="flex flex-col lg:flex-row lg:justify-between gap-6 lg:gap-0">
        ...
        <div className="flex flex-col gap-4 lg:gap-2 lg:items-end">
          <img
            className="w-32 h-8 md:w-48 md:h-12 lg:w-[256px] lg:h-[61px] object-contain"
      ...
      <div className="flex flex-col gap-4 md:gap-6 lg:gap-8 mt-6 md:mt-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
          <img
            className="w-full h-32 md:h-48 lg:h-[299px] object-cover rounded-lg col-span-1 md:col-span-2"
            src="/image/upacara-1.webp"
            alt="achievement"
          />
          <img
            className="w-full h-32 md:h-48 lg:h-[299px] object-cover rounded-lg"
            src="/image/green.webp"
            alt="achievement"
          />
          <img
            className="w-full h-32 md:h-48 lg:h-[299px] object-cover rounded-lg col-span-1 md:col-span-1"
            src="/image/fotbar ra.webp"
            alt="achievement"
          />
        </div>
        <div className="hidden md:grid md:grid-cols-4 gap-2 md:gap-4">
          <img
            className="w-full h-48 lg:h-[299px] object-cover rounded-lg"
            src="/image/fotbar yayasan.webp"
            alt="achievement"
          />
          <img
            className="w-full h-48 lg:h-[299px] object-cover rounded-lg col-span-2"
            src="/image/fotbar smk.webp"
            alt="achievement"
          />
          <img
            className="w-full h-48 lg:h-[299px] object-cover rounded-lg"
            src="/image/fotbar smp.webp"
            alt="achievement"
          />
        </div>
      </div>
