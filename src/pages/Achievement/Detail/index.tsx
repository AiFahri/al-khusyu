...
export function Detail() {
  const AchievementList = [
    ...
    },
    {
      ...
      summary:
        "Siswa SMK Al-Khusyu' berhasil mengembangkan startup kreatif di bidang digital...",
    ...
    <div className="flex flex-col lg:flex-row justify-start gap-6 lg:gap-8">
      <div className="flex flex-col gap-6 md:gap-8 w-full lg:w-1/2">
        ...
        <div className="font-manrope text-[#757575] text-sm md:text-base lg:text-lg xl:text-[20px] bg-white rounded-2xl px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8 flex items-center leading-relaxed">
          Kami menghadirkan program pendidikan yang menyeluruh untuk membentuk
          pribadi yang seimbang antara ilmu dan iman.
        </div>
