                            ...
                            >
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-4 p-6 lg:p-8">
                                    <div>
                                        ...
                                        <Link to="/pendidikan/tk" className="block py-2 hover:text-[#63817E]" onClick={() => setEduOpen(false)}>RA Al-Khusyu'</Link>
                            ...
                            <div>
                                ...
                                {eduOpen && (
                                    <div className="mt-2 pl-4 space-y-2">
                                        ...
                                        <Link to="/pendidikan/tk" className="block py-2 pl-4 text-gray-600 hover:text-[#63817E] hover:bg-gray-50 rounded">RA Al-Khusyu'</Link>
